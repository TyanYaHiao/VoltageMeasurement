...
//инициализация таймера2 для отсчета миллисекунд, вызывается из SystemInit()
...
//Timer 2 has internal PLL, which double this frequency for timer, up to 40MHz in our case
void init_ms_timer()
{
